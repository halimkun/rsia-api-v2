        ...
        <main style="margin-top: 125px;">
            ...
            <div>
                <div class="float-right mt-8 text-center">
                    @php
                        $QRDokter = 'Dikeluarkan di RSIA Aisyiyah Pekajangan, Ditandatangani secara elektronik oleh ' . \App\Helpers\SafeAccess::object($operasi, 'detailOperator1->nm_dokter') . '. ID : ' . \App\Helpers\SafeAccess::object($operasi, "detailOperator1->sidikjari->sidikjari");
                    @endphp
