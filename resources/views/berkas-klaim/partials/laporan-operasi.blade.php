        ...
        <main style="margin-top: 125px;">
            <table class="table w-full table-auto">
                <tr>
                    <td class="border px-1 align-top" style="border: 1px solid #333;" colspan="2">
                        ...
                        <p class="text-nowrap whitespace-nowrap">{{ SafeAccess::object($operasi, 'detailOperator1->nm_dokter', '-') }}</p>
                    </td>
                    <td class="border px-1 align-top" style="border: 1px solid #333;">
                        <p class="font-bold">Asisten :</p>
                        <p class="text-nowrap whitespace-nowrap">{{ SafeAccess::object($operasi, 'detailAsistenOperator1->nama', '-') }}</p>
                    </td>
                    <td class="border px-1 align-top" style="border: 1px solid #333;">
                        <p class="font-bold">Perawat :</p>
                        <p class="text-nowrap whitespace-nowrap">{{ SafeAccess::object($operasi, 'detailAsistenOperator2->nama', '-') }}</p>
                    </td>
                </tr>
                <tr>
                    <td class="border px-1 align-top" style="border: 1px solid #333;" colspan="2">
                        <p class="font-bold">Dokter Ahli Anestesi :</p>
                        <p>{{ SafeAccess::object($operasi, 'detailDokterAnestesi->nm_dokter', '-') }}</p>
                    </td>
                    <td class="border px-1 align-top" style="border: 1px solid #333;" colspan="2">
                        <p class="font-bold">Jenis Anestesi :</p>
                        <p>{{ SafeAccess::object($operasi, 'jenis_anestesi', '-') }}</p>
                    </td>
                </tr>
                <tr>
                    <td class="border px-1 align-top" style="border: 1px solid #333;" colspan="2">
                        <p class="font-bold">Diagnosa Pre Operatif :</p>
                        <p>{{ SafeAccess::object($operasi, 'diagnosa_preop', '-') }}</p>
                    </td>
                    <td class="border px-1 align-top" style="border: 1px solid #333;" colspan="2">
                        <p class="font-bold">Diagnosa Post Operatif :</p>
                        <p>{{ SafeAccess::object($operasi, 'diagnosa_postop', '-') }}</p>
                    </td>
                </tr>
                <tr>
                    <td class="border px-1 align-top" style="border: 1px solid #333;" colspan="2">
                        ...
                        <ul class="ml-4">
                            <li>{{ SafeAccess::object($operasi, 'darah_masuk', '-') }}</li>
                        </ul>

                        <p class="font-bold">Jumlah darah yang hilang :</p>
                        <ul class="ml-4">
                            <li>{{ SafeAccess::object($operasi, 'darah_hilang', '-') }}</li>
                        </ul>
                    </td>
                    <td class="border px-1 align-top" style="border: 1px solid #333;" colspan="2">
                        <p class="font-bold">Komplikasi :</p>
                        <p>{{ SafeAccess::object($operasi, 'komplikasi', '-') }}</p>
                    </td>
                </tr>
                <tr>
                    <td class="border px-1 align-top" style="border: 1px solid #333;" colspan="2">
                        <p class="font-bold">Jaringan yang di-Eksis/insisi :</p>
                        <p>{{ SafeAccess::object($operasi, 'jaringan_insisi', '-') }}</p>
                    </td>
                    <td class="border px-1 align-top" style="border: 1px solid #333;" colspan="2">
                        <p class="font-bold">Pemeriksa PA :</p>
                        <p>{{ SafeAccess::object($operasi, 'pemeriksaan_pa', '-') }}</p>
                    </td>
                </tr>
                <tr>
                    <td class="border px-1 align-top" style="border: 1px solid #333;">
                        <p class="font-bold">Tanggal Operasi :</p>
                        <p>{{ explode(' ', SafeAccess::object($operasi, 'tgl_operasi', ''))[0] }}</p>
                    </td>
                    <td class="border px-1 align-top" style="border: 1px solid #333;">
                        <p class="font-bold">Jam Mulai Operasi :</p>
                        <p>{{ explode(' ', SafeAccess::object($operasi, 'tgl_operasi', ''))[1] }}</p>
                    </td>
                    <td class="border px-1 align-top" style="border: 1px solid #333;">
                        <p class="font-bold">Jam Selesai Operasi :</p>
                        <p>{{ explode(' ', SafeAccess::object($operasi, 'tgl_selesai', ''))[1] }}</p>
                    </td>
                    <td class="border px-1 align-top" style="border: 1px solid #333;">
                ...
                <tr>
                    <td class="border px-1 align-top" style="border: 1px solid #333;" colspan="4">
                        ...
                        <p>{{ SafeAccess::object($operasi, 'detailPaket.nm_perawatan', '-') }}</p>
                    </td>
                </tr>
                <tr>
                    <td class="border px-1 align-top" style="border: 1px solid #333;" colspan="4">
                        <p class="mb-3 font-bold">Laporan Jalannya Operasi :</p>
                        <p class="leading-4">{!! nl2br(SafeAccess::object($operasi, 'laporan_operasi', '-')) !!}</p>
                    </td>
                </tr>
            </table>
            ...
            <div>
                <div class="float-right mt-8 text-center">
                    @php
                        $QRDokter = 'Dikeluarkan di RSIA Aisyiyah Pekajangan, Ditandatangani secara elektronik oleh ' . SafeAccess::object($operasi, 'detailOperator1->nm_dokter') . '. ID : ' . SafeAccess::object($operasi, "detailOperator1->sidikjari->sidikjari");
                    @endphp
                    ...
                    <p>{{ SafeAccess::object($operasi, 'detailOperator1->nm_dokter') }}</p>
                </div>
            </div>
        </main>
    @endpush
