    ...
    <main class="mt-4">
        ...
        <table class="mt-4 w-full">
            ...
            <tr class="align-middle">
                ...
                <td class="border-b border-t" style="border-color: #333, #333">:</td>
                <td class="border-b border-t" style="border-color: #333, #333">{{ \Carbon\Carbon::parse($pasien?->tgl_lahir)->diff(\Carbon\Carbon::now())->format('%y T %m B %d H') }}</td>
            </tr>
            <tr class="align-middle">
                ...
                <td class="border-b border-t" style="border-color: #333, #333">:</td>
                <td class="border-b border-t" style="border-color: #333, #333">{{ \Carbon\Carbon::parse($pasien?->tgl_lahir)->translatedFormat('d F Y') }}</td>
            </tr>
            <tr class="align-middle">
