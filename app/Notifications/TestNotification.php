...
class TestNotification extends Notification
{
     ...
     * @return void
     */
    public function __construct(string $topic, \App\Models\RsiaTemplateNotifikasi $notificationTemplate, \Illuminate\Support\Collection $request = null)
    {
        $this->topic                = $topic;
    ...
    {
        $dokter        = $this->request ? \App\Models\Dokter::where('kd_dokter', $this->request->get('nik'))->first() : collect([]);
        $parsedRequest = $this->request ? collect($this->request->get('parse')) : collect([]);
        ...
        $body   = \App\Helpers\Notification\ParseNotificationMessage::run($this->notificationTemplate->body, $templateData);
        $detail = \App\Helpers\Notification\ParseNotificationMessage::run($this->notificationTemplate->detail, $templateData);
