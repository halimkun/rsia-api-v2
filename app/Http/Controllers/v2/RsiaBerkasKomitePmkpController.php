...
class RsiaBerkasKomitePmkpController extends Controller
{
     ...
     * 
     * Menampilkan semua data yang ada pada tabel berkas komite pmkp. data akan diurutkan berdasarkan tanggal terbit data secara descending. dan diformat dalam bentuk paginasi.
     * 
    ...
    */
    ...
    public function store(Request $request)
    {
        ...
        $nomor = \App\Helpers\komite\LastNomor::get(new \App\Models\RsiaBerkasKomitePmkp(), $request->tgl_terbit);
        $buildedNomor = [
        ...
        try {
            DB::transaction(function () use ($request) {
                \App\Models\RsiaBerkasKomitePmkp::create($request->all());
            });
        } catch (\Exception $e) {
    ...
    public function update(Request $request, $base64NomorTglTerbit)
    {
        ...
        $data = \App\Models\RsiaBerkasKomitePmkp::where('nomor', $request->nomor)
