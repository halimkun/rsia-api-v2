...
class RsiaBerkasKomitePpiController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $data = \App\Models\RsiaBerkasKomitePpi::select(array_map('trim', explode(',', $select)))
    ...
    public function search(Request $request)
    {
        ...
        $fd = new \App\Services\GetFilterData(new \App\Models\RsiaBerkasKomitePpi(), $orion_request, $actionMethod);
        $query = $fd->apply();
    ...
    public function store(Request $request)
    {
        ...
        $nomor = \App\Helpers\komite\LastNomor::get(new \App\Models\RsiaBerkasKomitePpi(), $request->tgl_terbit);
        $buildedNomor = [
        ...
        try {
            DB::transaction(function () use ($request) {
                \App\Models\RsiaBerkasKomitePpi::create($request->all());
            });
        } catch (\Exception $e) {
    ...
    public function show($base64NomorTglTerbit)
    {
        ...
        $data = \App\Models\RsiaBerkasKomitePpi::where('nomor', $identifier[0])
    ...
    public function update(Request $request, $base64NomorTglTerbit)
    {
        ...
        $data = \App\Models\RsiaBerkasKomitePpi::where('nomor', $request->nomor)
