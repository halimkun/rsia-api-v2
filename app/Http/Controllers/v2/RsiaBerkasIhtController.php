...
class RsiaBerkasIhtController extends Controller
{
    ...
    public function show($base64NomorTglTerbit)
    {
        if (!base64_decode($base64NomorTglTerbit, true)) {
            return \App\Helpers\ApiResponse::error("Invalid parameter : pastikan parameter adalah base64 encoded dari nomor dan tanggal misal : 53.2024-03-28", "invalid_params", null, 400);
        }
