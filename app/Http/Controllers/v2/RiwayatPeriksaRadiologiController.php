...
class RiwayatPeriksaRadiologiController extends Controller
{
    /**
    ...
    public function index($rm, $noRawat)
    {
        ...
        $riwayat = \App\Models\PeriksaRadiologi::with('petugas', 'dokter', 'jenisPerawatan', 'dokterPerujuk', 'jenisPerawatan')->where('no_rawat', $noRawat)->paginate(10);
